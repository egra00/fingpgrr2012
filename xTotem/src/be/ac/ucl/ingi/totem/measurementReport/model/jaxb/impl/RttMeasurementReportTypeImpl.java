...
public class RttMeasurementReportTypeImpl implements be.ac.ucl.ingi.totem.measurementReport.model.jaxb.RttMeasurementReportType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Measures;
    protected be.ac.ucl.ingi.totem.measurementReport.model.jaxb.Information _Info;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ucl.ingi.totem.measurementReport.model.jaxb.RttMeasurementReportType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getMeasures() {
        if (_Measures == null) {
            _Measures = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Measures;
    }
    ...
    public be.ac.ucl.ingi.totem.measurementReport.model.jaxb.Information getInfo() {
        return _Info;
    }

    public void setInfo(be.ac.ucl.ingi.totem.measurementReport.model.jaxb.Information value) {
        _Info = value;
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ucl.ingi.totem.measurementReport.model.jaxb.impl.RttMeasurementReportTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Measures == null)? 0 :_Measures.size());
        ...
        context.endElement();
        while (idx1 != len1) {
            context.startElement("", "measures");
            int idx_2 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Measures.get(idx_2 ++)), "Measures");
            context.endNamespaceDecls();
            int idx_3 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Measures.get(idx_3 ++)), "Measures");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Measures.get(idx1 ++)), "Measures");
            context.endElement();
        }
    }
...
+"ngi.totem.measurementReport.model.jaxb.Informationt\u0000+http://"
...
+"eq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0004infot\u0000\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u000eq\u0000~\u0000\u0012psq\u0000~\u0000\u0006q\u0000~\u0000\u0012p\u0000sq\u0000~\u0000"
+"\u0000ppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u000eq\u0000~\u0000\u0012psq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001cs"
+"q\u0000~\u0000\u001dt\u0000@be.ac.ucl.ingi.totem.measurementReport.model.jaxb.Su"
+"bnetMeasuresq\u0000~\u0000!sq\u0000~\u0000\fppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00007q\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000"
+"\bmeasuresq\u0000~\u0000<q\u0000~\u0000\u001csr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000"
...
+"grammar/ExpressionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\rq\u0000~\u0000Bq\u0000~\u0000\nq\u0000~\u0000@q\u0000~\u0000\u0005q\u0000~\u0000"
+">q\u0000~\u0000=q\u0000~\u0000\u0010q\u0000~\u0000Cq\u0000~\u0000\"q\u0000~\u0000Gx"));
        }
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ucl.ingi.totem.measurementReport.model.jaxb.impl.RttMeasurementReportTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("subnet" == ___local)&&("" == ___uri)) {
                            _getMeasures().add(((be.ac.ucl.ingi.totem.measurementReport.model.jaxb.impl.SubnetMeasuresImpl) spawnChildFromEnterElement((be.ac.ucl.ingi.totem.measurementReport.model.jaxb.impl.SubnetMeasuresImpl.class), 5, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  6 :
                    ...
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _Info = ((be.ac.ucl.ingi.totem.measurementReport.model.jaxb.impl.InformationImpl) spawnChildFromEnterElement((be.ac.ucl.ingi.totem.measurementReport.model.jaxb.impl.InformationImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
