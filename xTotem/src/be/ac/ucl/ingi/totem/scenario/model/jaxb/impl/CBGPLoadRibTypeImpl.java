...
public class CBGPLoadRibTypeImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl
    implements be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPLoadRibType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPLoadRibType.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.Unmarshaller(context);
    }
...
+"\u0000~\u0000!q\u0000~\u0000/q\u0000~\u0000\u001asq\u0000~\u0000#t\u0000\u0004fileq\u0000~\u0000\'sq\u0000~\u0000\tppq\u0000~\u0000,sq\u0000~\u0000#t\u0000\u0004nodeq\u0000"
...
+"onPool;xp\u0000\u0000\u0000\u0003\u0001pq\u0000~\u0000\u0006q\u0000~\u0000\u0005q\u0000~\u0000\bx"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                        attIdx = context.getAttribute("", "node");
                        if (attIdx >= 0) {
                ...
                switch (state) {
                    case  6 :
                        if (("time" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                            return ;
                        }
                        spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  5 :
                        if (("node" == ___local)&&("" == ___uri)) {
                            state = 6;
                ...
                try {
                    switch (state) {
                        ...
                        case  6 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl.this).new Unmarshaller(context)), 7, value);
                            return ;
                        case  3 :
                            attIdx = context.getAttribute("", "node");
                            if (attIdx >= 0) {
