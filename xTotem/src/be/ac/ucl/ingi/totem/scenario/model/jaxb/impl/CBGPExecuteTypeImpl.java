...
public class CBGPExecuteTypeImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl
    implements be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPExecuteType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPExecuteType.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.Unmarshaller(context);
    }
    ...
    public void serializeAttributes(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startAttribute("", "command");
        try {
...
+".q\u0000~\u0000\u0019sq\u0000~\u0000\"t\u0000\u0007commandq\u0000~\u0000&sr\u0000\"com.sun.msv.grammar.Expressio"
...
+"sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0002\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0007x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        attIdx = context.getAttribute("", "command");
                        if (attIdx >= 0) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  4 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  4 :
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("time" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                            return ;
                        }
                        spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  4 :
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPExecuteTypeImpl.this).new Unmarshaller(context)), 4, value);
                            return ;
                        case  4 :
