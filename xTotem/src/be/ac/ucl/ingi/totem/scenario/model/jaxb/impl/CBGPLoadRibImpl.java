...
public class CBGPLoadRibImpl
    extends be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl
    implements be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPLoadRib, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPLoadRib.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibImpl.Unmarshaller(context);
    }

    public void serializeBody(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://jaxb.model.scenario.totem.ingi.ucl.ac.be", "CBGPLoadRib");
...
+"sq\u0000~\u0000%q\u0000~\u00003q\u0000~\u0000\u001esq\u0000~\u0000\'t\u0000\u0004fileq\u0000~\u0000+sq\u0000~\u0000\u000eppq\u0000~\u00000sq\u0000~\u0000\'t\u0000\u0004node"
...
+"anceq\u0000~\u0000-sq\u0000~\u0000\'t\u0000\u000bCBGPLoadRibt\u0000/http://jaxb.model.scenario.t"
+"otem.ingi.ucl.ac.besr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000"
...
+"grammar/ExpressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u000bq\u0000~\u0000\nq\u0000~\u0000\rq\u0000~\u0000\tq\u0000~\u0000<x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("CBGPLoadRib" == ___local)&&("http://jaxb.model.scenario.totem.ingi.ucl.ac.be" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("file" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPLoadRibImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                }
