...
import be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPPeerUpImpl;
 ...
 *
 */
public class CBGPPeerUp extends CBGPPeerUpImpl implements Event {
    
    private static final Logger logger = Logger.getLogger(CBGPPeerUp.class);
    ...
    public EventResult action() throws EventExecutionException {
        try {
            ...
            try {
                cbgp.bgpRouterPeerUp(sNode, sPeer, true);
            } catch (RoutingException e) {
                System.out.println("CBGPPeerUp command failed");
        ...
        logger.info("CBGPPeerUp executed.");
