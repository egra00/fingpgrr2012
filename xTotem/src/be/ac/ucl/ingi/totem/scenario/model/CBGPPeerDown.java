...
import be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPPeerDownImpl;
 ...
 *
 */
public class CBGPPeerDown extends CBGPPeerDownImpl implements Event {
    
    private static final Logger logger = Logger.getLogger(CBGPPeerDown.class);
    ...
    public EventResult action() throws EventExecutionException {
        try {
            ...
            try {
                cbgp.bgpRouterPeerUp(sNode, sPeer, false);
            } catch (RoutingException e) {
                System.out.println("CBGPPeerDown command failed");
        ...
        logger.info("CBGPPeerDown executed.");
