...
public class CBGPRunImpl
    extends be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl
    implements be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPRun, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPRun.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunImpl.Unmarshaller(context);
    }

    public void serializeBody(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://jaxb.model.scenario.totem.ingi.ucl.ac.be", "CBGPRun");
...
+"\u0000~\u0000\rq\u0000~\u0000\u0010psq\u0000~\u0000\u0011ppsr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000"
+"\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000\u0017q\u0000~\u0000\u001dt\u0000\u0006stringsr\u00005com.sun.msv."
+"datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000 \u0001q"
+"\u0000~\u0000#sq\u0000~\u0000$q\u0000~\u00003q\u0000~\u0000\u001dsq\u0000~\u0000&t\u0000\u0006stopAtq\u0000~\u0000*q\u0000~\u0000,sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq"
+"\u0000~\u0000\u0010psq\u0000~\u0000\u0011ppsr\u0000\"com.sun.msv.datatype.xsd.QnameType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
+"\u0000\u0000xq\u0000~\u0000\u0017q\u0000~\u0000\u001dt\u0000\u0005QNameq\u0000~\u0000!q\u0000~\u0000#sq\u0000~\u0000$q\u0000~\u0000>q\u0000~\u0000\u001dsq\u0000~\u0000&t\u0000\u0004type"
+"t\u0000)http://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000,sq\u0000~\u0000&t\u0000\u0007CB"
+"GPRunt\u0000/http://jaxb.model.scenario.totem.ingi.ucl.ac.besr\u0000\"c"
...
+"p\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000.q\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000\nq\u0000~\u00009x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("CBGPRun" == ___local)&&("http://jaxb.model.scenario.totem.ingi.ucl.ac.be" == ___uri)) {
                        ...
                        break;
                    case  1 :
                        attIdx = context.getAttribute("", "stopAt");
                        if (attIdx >= 0) {
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        if (("stopAt" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  1 :
                            ...
                            spawnHandlerFromText((((be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
