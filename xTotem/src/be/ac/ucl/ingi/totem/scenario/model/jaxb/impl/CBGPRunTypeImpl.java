...
public class CBGPRunTypeImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl
    implements be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPRunType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{

    protected java.lang.String _StopAt;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ucl.ingi.totem.scenario.model.jaxb.CBGPRunType.class);
    }
    ...
    public void setStopAt(java.lang.String value) {
        _StopAt = value;
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (_StopAt!= null) {
            context.startAttribute("", "stopAt");
            try {
                context.text(((java.lang.String) _StopAt), "StopAt");
...
+"q\u0000~\u0000\u0007q\u0000~\u0000\u0005x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("time" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                            return ;
                        }
                        spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("stopAt" == ___local)&&("" == ___uri)) {
                            state = 3;
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ucl.ingi.totem.scenario.model.jaxb.impl.CBGPRunTypeImpl.this).new Unmarshaller(context)), 4, value);
                            return ;
                        case  1 :
                            eatText1(value);
                            state = 2;
