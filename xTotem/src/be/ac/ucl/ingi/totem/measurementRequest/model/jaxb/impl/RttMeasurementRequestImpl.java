...
public class RttMeasurementRequestImpl
    extends be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestTypeImpl
    implements be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.RttMeasurementRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.RttMeasurementRequest.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "rttMeasurementRequest");
...
+"spaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000\\be.ac.ucl.ingi.totem.measurementReques"
+"t.model.jaxb.RttMeasurementRequestType.RequestListTypet\u0000+htt"
...
+"tanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000brequestListt\u0000\u0000q\u0000~\u0000\u001fsq\u0000~\u0000\nppsq\u0000~\u0000\u0016q\u0000~\u0000\u0010pq\u0000"
+"~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0015rttMeasurementRequestq\u0000~\u0000?sr\u0000\"com.sun."
...
+"q\u0000~\u0000%q\u0000~\u0000@q\u0000~\u0000\u0015q\u0000~\u0000\u0014q\u0000~\u0000\u000bq\u0000~\u0000\u000eq\u0000~\u0000\tq\u0000~\u0000\u0012x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("requestList" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestTypeImpl)be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestTypeImpl)be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
                        if (("rttMeasurementRequest" == ___local)&&("" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestTypeImpl)be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("rttMeasurementRequest" == ___local)&&("" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestTypeImpl)be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestTypeImpl)be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestTypeImpl)be.ac.ucl.ingi.totem.measurementRequest.model.jaxb.impl.RttMeasurementRequestImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
