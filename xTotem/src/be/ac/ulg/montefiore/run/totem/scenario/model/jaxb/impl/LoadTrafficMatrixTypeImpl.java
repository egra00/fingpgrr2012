...
public class LoadTrafficMatrixTypeImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TMEventTypeImpl
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.LoadTrafficMatrixType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.LoadTrafficMatrixType.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LoadTrafficMatrixTypeImpl.Unmarshaller(context);
    }
...
+"tefiore.ulg.ac.bet\u0000\bTMIdTypeq\u0000~\u0000\u001esr\u0000 com.sun.msv.datatype.xs"
...
+"\u0000~\u0000!q\u0000~\u00007q\u0000~\u00002sq\u0000~\u0000#t\u0000\u0004TMIDq\u0000~\u0000\'q\u0000~\u0000)sq\u0000~\u0000\tppsq\u0000~\u0000\u000eppsr\u0000#com"
...
+"r/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\u0006q\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000+x"));
        }
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LoadTrafficMatrixTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LoadTrafficMatrixTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LoadTrafficMatrixTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("TMID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LoadTrafficMatrixTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LoadTrafficMatrixTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("file" == ___local)&&("" == ___uri)) {
                            state = 3;
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LoadTrafficMatrixTypeImpl.this).new Unmarshaller(context)), 4, value);
                            return ;
                        case  1 :
                            eatText1(value);
                            state = 2;
