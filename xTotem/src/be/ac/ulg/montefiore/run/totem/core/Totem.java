...
public class Totem {
    ...
    private static void printUsage() {
        ...
        System.out.println("\t -rrloc_bgpsep <topology.xml> [-separator] [-max_iter] [-alpha] [-beta] [-gama] [-nb_run] [-n_gen] [-sizeP] [-sizeOf] [-pmut] [-pcross]: " +
        		"start BGPSEP algorithm running over the topology specifies in topology.xml.");
        System.out.println("\t -rrloc_bgpsepB <topology.xml> [-separator] -PoPs [-max_iter] [-alpha] [-beta] [-gama] [-km_nb_run] [-km_n_gen] [-km_sizeP] [-km_sizeOf] [-km_pmut] [-km_pcross]" +
        		"[-nb_run] [-n_gen] [-sizeP] [-sizeOf] [-pmut] [-pcross]: start BGPSEPBackbone algorithm running over the topology specifies in topology.xml.");
        System.out.println("\t -rrloc_bgpsepD <topology.xml> [-separator] [-max_iter] [-alpha] [-beta] [-gama] [-nb_run] [-n_gen] [-sizeP] [-sizeOf] [-pmut] [-pcross]: " +
        		"start BGPSEPD algorithm running over the topology specifies in topology.xml.");
        System.out.println("\t -rrloc_bgpsepS <topology.xml> [-separator] [-max_iter] [-alpha] [-beta] [-gama] [-nb_run] [-n_gen] [-sizeP] [-sizeOf] [-pmut] [-pcross]: " +
