...
* Changes:
* --------
* - 30-Jun-2006 : adapt methods to match VertexStringer interface of Jung new version (GMO)
*/
...
public class NodeLabeller implements VertexStringer {
    ...
    public String getLabel(ArchetypeVertex v) {
        try {
            return String.valueOf(((Node) v.getUserDatum(MyVisualizationViewer.TKEY)).getId());
        } catch (Exception ex) {
