    ...
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.LinkUpType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.LinkUpType.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpTypeImpl.Unmarshaller(context);
    }
...
+"#t\u0000\u0006linkIdq\u0000~\u0000\'sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000"
...
+"mar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000+q\u0000~\u0000\u0006q\u0000~\u0000\bq\u0000~\u0000\u0005x"));
        }
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  0 :
                        attIdx = context.getAttribute("", "linkId");
                        if (attIdx >= 0) {
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("ASID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                    case  0 :
                        attIdx = context.getAttribute("", "linkId");
                        if (attIdx >= 0) {
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpTypeImpl.this).new Unmarshaller(context)), 4, value);
                            return ;
                        case  0 :
                            attIdx = context.getAttribute("", "linkId");
                            if (attIdx >= 0) {
