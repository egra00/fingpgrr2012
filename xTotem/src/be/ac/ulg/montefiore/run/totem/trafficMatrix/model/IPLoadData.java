 ...
 */
public interface IPLoadData extends LoadData {
    /**
     * Same as {@link #getLoad(be.ac.ulg.montefiore.run.totem.domain.model.Link)} but returns the only the ip load
    ...
    /**
     * Same as {@link #getLoad()} but returns only the ip load.
     * (traffic not routed on LSPs).
     * @return
     */
