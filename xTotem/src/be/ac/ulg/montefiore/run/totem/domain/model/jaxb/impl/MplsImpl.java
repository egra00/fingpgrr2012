...
public class MplsImpl implements be.ac.ulg.montefiore.run.totem.domain.model.jaxb.Mpls, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Lsp;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.domain.model.jaxb.Mpls.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getLsp() {
        if (_Lsp == null) {
            _Lsp = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Lsp;
    }

    public java.util.List getLsp() {
        return _getLsp();
    }

    public boolean isSetLsp() {
        return ((_Lsp == null)?false:_Lsp.isModified());
    }

    public void unsetLsp() {
        if (_Lsp!= null) {
            _Lsp.clear();
            _Lsp.setModified(false);
        }
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.domain.model.jaxb.impl.MplsImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Lsp == null)? 0 :_Lsp.size());
        while (idx1 != len1) {
            context.startElement("", "lsp");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Lsp.get(idx_0 ++)), "Lsp");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Lsp.get(idx_1 ++)), "Lsp");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Lsp.get(idx1 ++)), "Lsp");
            context.endElement();
        }
    }
...
+"calNamet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u00004be."
+"ac.ulg.montefiore.run.totem.domain.model.jaxb.Lspt\u0000+http://j"
...
+"q\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0003lspt\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000"
...
+"/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\fq\u0000~\u0000\u000fq\u0000~\u0000\"q\u0000~\u0000\u0005x"));
        }
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.domain.model.jaxb.impl.MplsImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _getLsp().add(((be.ac.ulg.montefiore.run.totem.domain.model.impl.LspImpl) spawnChildFromEnterAttribute((be.ac.ulg.montefiore.run.totem.domain.model.impl.LspImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
