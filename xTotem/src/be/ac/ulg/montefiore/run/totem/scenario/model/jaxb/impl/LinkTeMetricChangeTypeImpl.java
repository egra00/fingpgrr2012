...
public class LinkTeMetricChangeTypeImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.LinkTeMetricChangeType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.LinkTeMetricChangeType.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkTeMetricChangeTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (!has_Metric) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "Metric"));
        }
...
+"~\u0000\u001bsq\u0000~\u0000$t\u0000\u0006linkIdq\u0000~\u0000(sq\u0000~\u0000\nppsq\u0000~\u0000\u000fppsr\u0000\"com.sun.msv.datat"
+"ype.xsd.FloatType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000+com.sun.msv.datatype.xsd.Flo"
+"atingNumberType\u00fc\u00e3\u00b6\u0087\u008c\u00a8|\u00e0\u0002\u0000\u0000xq\u0000~\u0000\u0015q\u0000~\u0000\u001bt\u0000\u0005floatq\u0000~\u0000\u001fq\u0000~\u0000!sq\u0000~\u0000"
+"\"q\u0000~\u0000lq\u0000~\u0000\u001bsq\u0000~\u0000$t\u0000\u0006metricq\u0000~\u0000(sr\u0000\"com.sun.msv.grammar.Expre"
...
+"~\u0000\u0006q\u0000~\u0000,x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkTeMetricChangeTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkTeMetricChangeTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  7 :
                    ...
                    case  0 :
                        ...
                        break;
                    case  3 :
                        attIdx = context.getAttribute("", "metric");
                        if (attIdx >= 0) {
                            final java.lang.String v = context.eatAttribute(attIdx);
                            eatText2(v);
                            state = 6;
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkTeMetricChangeTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  7 :
                ...
                switch (state) {
                    case  6 :
                        if (("ASID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkTeMetricChangeTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkTeMetricChangeTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  7 :
                ...
                try {
                    switch (state) {
                        case  6 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkTeMetricChangeTypeImpl.this).new Unmarshaller(context)), 7, value);
                            return ;
                        case  7 :
