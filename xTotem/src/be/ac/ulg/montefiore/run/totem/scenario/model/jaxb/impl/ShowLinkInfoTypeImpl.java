    ...
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ShowLinkInfoType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ShowLinkInfoType.class);
    }

    public be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.InfoLinkType getType() {
        if (_Type == null) {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.InfoLinkType.LOAD;
        } else {
            return _Type;
        }
    }

    public void setType(be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.InfoLinkType value) {
        _Type = value;
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkInfoTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_Type!= null) {
            ...
            try {
                context.text(((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.InfoLinkType) _Type).toString(), "Type");
            } catch (java.lang.Exception e) {
                be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endAttribute();
...
+"\u0000\'t\u0000\u0007SPFtypeq\u0000~\u0000+q\u0000~\u0000-sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0012ppsr\u0000)com.su"
+"n.msv.datatype.xsd.EnumerationFacet\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0006valuest\u0000\u000fLj"
+"ava/util/Set;xq\u0000~\u0000?q\u0000~\u00006t\u0000\finfoLinkTypeq\u0000~\u0000x\u0000\u0000q\u0000~\u0000uq\u0000~\u0000ut\u0000\u000be"
+"numerationsr\u0000\u0011java.util.HashSet\u00baD\u0085\u0095\u0096\u00b8\u00b74\u0003\u0000\u0000xpw\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000\u0000\u0006t\u0000"
+"\u000ePRIMARY_BACKUPt\u0000\u0004LOADt\u0000\fLOAD_OVERLAYt\u0000\u000bRESERVATIONt\u0000\u0007LOAD_I"
+"St\u0000\bLOAD_BISxq\u0000~\u0000$sq\u0000~\u0000%q\u0000~\u0000\u0082q\u0000~\u00006sq\u0000~\u0000\'t\u0000\u0004typeq\u0000~\u0000+q\u0000~\u0000-sq\u0000"
+"~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011pq\u0000~\u0000jsq\u0000~\u0000\'t\u0000\u0007verboseq\u0000~\u0000+q\u0000~\u0000-sr\u0000\"com.sun."
...
+"q\u0000~\u0000\fx"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkInfoTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  12 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkInfoTypeImpl.this).new Unmarshaller(context)), 13, ___uri, ___local, ___qname, __atts);
                        return ;
                }
        ...
        {
            try {
                _Type = be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.InfoLinkType.fromString(value);
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  12 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkInfoTypeImpl.this).new Unmarshaller(context)), 13, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                switch (state) {
                    ...
                    case  12 :
                        if (("TMID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkInfoTypeImpl.this).new Unmarshaller(context)), 13, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  12 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkInfoTypeImpl.this).new Unmarshaller(context)), 13, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  12 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkInfoTypeImpl.this).new Unmarshaller(context)), 13, value);
                            return ;
                    }
