...
public class ChartCreationTypeImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ChartCreationType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{

    protected be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ChartCreationType.CollectorType _Collector;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ChartCreationType.class);
    }

    public be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ChartCreationType.CollectorType getCollector() {
        return _Collector;
    }

    public void setCollector(be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ChartCreationType.CollectorType value) {
        _Collector = value;
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.Unmarshaller(context);
    }
...
+"\u0000\u001at\u0000Rbe.ac.ulg.montefiore.run.totem.scenario.model.jaxb.Char"
+"tCreationType.CollectorTypet\u0000+http://java.sun.com/jaxb/xjc/d"
...
+"p://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\tcollecto"
+"rt\u00009http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.b"
+"esq\u0000~\u0000\rppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013psq\u0000~\u0000%ppsr\u0000!com.sun.msv.datatype.xsd.Ti"
+"meType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv.datatype.xsd.DateTimeBaseTy"
+"pe\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000*q\u0000~\u0000/t\u0000\u0004timeq\u0000~\u00003q\u0000~\u00005sq\u0000~\u00006q\u0000~\u0000Dq\u0000~\u0000/sq\u0000"
+"~\u0000\u001et\u0000\u0004timet\u0000\u0000q\u0000~\u0000\u001dsq\u0000~\u0000\u0014ppsq\u0000~\u0000%ppsr\u0000\'com.sun.msv.datatype.x"
+"sd.FinalComponent\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001I\u0000\nfinalValuexr\u0000\u001ecom.sun.msv.dat"
+"atype.xsd.Proxy\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bbaseTypet\u0000)Lcom/sun/msv/datatyp"
+"e/xsd/XSDatatypeImpl;xq\u0000~\u0000,q\u0000~\u0000=t\u0000\u000bchartIdTypesr\u00005com.sun.ms"
+"v.datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00002"
+"sr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlway"
+"sValidxq\u0000~\u0000*q\u0000~\u0000/t\u0000\u0006stringq\u0000~\u0000Q\u0001\u0000\u0000\u0000\u0000q\u0000~\u00005sq\u0000~\u00006q\u0000~\u0000Tq\u0000~\u0000=sq\u0000"
+"~\u0000\u001et\u0000\u0002idq\u0000~\u0000Hsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
...
+"x"));
    ...
    public static class CollectorTypeImpl implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ChartCreationType.CollectorType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
    {
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ChartCreationType.CollectorType.class);
        }
        ...
        public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
            return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.CollectorTypeImpl.Unmarshaller(context);
        }
...
+"\u0000\n\u0001pq\u0000~\u0000\rq\u0000~\u0000\u0013q\u0000~\u0000\'q\u0000~\u0000+q\u0000~\u0000\nq\u0000~\u0000$q\u0000~\u0000\u0005q\u0000~\u0000\u0007q\u0000~\u0000\u0012q\u0000~\u0000&x"));
            ...
            extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.CollectorTypeImpl.this;
            }
                    ...
                    switch (state) {
                        case  4 :
                            if (("param" == ___local)&&("http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.be" == ___uri)) {
                                _getParam().add(((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ParamImpl) spawnChildFromEnterElement((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ParamImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                                return ;
                            }
                            if (("param" == ___local)&&("http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.be" == ___uri)) {
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname, __atts);
                        return ;
                }
                super.enterElement(___uri, ___local, ___qname, __atts);
                break;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                }
                super.leaveElement(___uri, ___local, ___qname);
                break;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  5 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _Collector = ((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.CollectorTypeImpl) spawnChildFromEnterAttribute((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.CollectorTypeImpl.class), 6, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  7 :
                    ...
                    case  3 :
                        if (("time" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                            return ;
                        }
                        spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.this).new Unmarshaller(context)), 4, ___uri, ___local, ___qname);
                        return ;
                }
                super.leaveAttribute(___uri, ___local, ___qname);
                break;
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.EventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ChartCreationTypeImpl.this).new Unmarshaller(context)), 4, value);
                            return ;
                    }
                } catch (java.lang.RuntimeException e) {
                    handleUnexpectedTextException(value, e);
