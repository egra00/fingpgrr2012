...
public class DeleteAllLSPImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPTypeImpl
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.DeleteAllLSP, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.DeleteAllLSP.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPImpl.Unmarshaller(context);
    }

    public void serializeBody(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.be", "deleteAllLSP");
...
+"w3.org/2001/XMLSchema-instanceq\u0000~\u0000,sq\u0000~\u0000&t\u0000\fdeleteAllLSPq\u0000~\u0000"
...
+"Pool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\fq\u0000~\u0000_q\u0000~\u0000.q\u0000~\u0000\tq\u0000~\u0000\nx"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("deleteAllLSP" == ___local)&&("http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.be" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("ASID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                ...
                try {
                    switch (state) {
                        case  1 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.DeleteAllLSPImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
