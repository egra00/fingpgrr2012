...
public abstract class BGPAwareObjectiveFunction {
    ...
    public abstract double getValue(LinkLoads linkLoads, Domain domain, boolean includeInterDomainLinks, boolean avoidHPReroutings);
