...
public class TemplateImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateTypeImpl
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.Template, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.Template.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.Unmarshaller(context);
    }

    public void serializeBody(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.be", "template");
...
+"t\u0000\u0004timesr\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Coll"
...
+"\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xpt\u0000\u0004timet\u0000\u0000sr\u00000com.sun.msv.grammar.Expression$Epsi"
+"lonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u000e\u0001q\u0000~\u0000+sq\u0000~\u0000\nppsq\u0000~\u0000\fq\u0000~\u0000"
+"\u000fpsq\u0000~\u0000\u0010ppsr\u0000\"com.sun.msv.datatype.xsd.QnameType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000x"
+"q\u0000~\u0000\u0016q\u0000~\u0000\u001ct\u0000\u0005QNameq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#q\u0000~\u00002q\u0000~\u0000\u001csq\u0000~\u0000%t\u0000\u0004typet\u0000)"
+"http://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000+sq\u0000~\u0000%t\u0000\btempl"
+"atet\u00009http://jaxb.model.scenario.totem.run.montefiore.ulg.ac"
+".besr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bexpTa"
...
+"onPool;xp\u0000\u0000\u0000\u0003\u0001pq\u0000~\u0000-q\u0000~\u0000\tq\u0000~\u0000\u000bx"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                ...
                switch (state) {
                    case  1 :
                        if (("time" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                ...
                try {
                    switch (state) {
                        case  1 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.TemplateImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
