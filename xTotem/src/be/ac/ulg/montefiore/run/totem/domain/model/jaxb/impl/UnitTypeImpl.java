...
public class UnitTypeImpl implements be.ac.ulg.montefiore.run.totem.domain.model.jaxb.UnitType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{

    protected be.ac.ulg.montefiore.run.totem.domain.model.jaxb.UnitsType _Type;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.domain.model.jaxb.UnitType.class);
    }

    public be.ac.ulg.montefiore.run.totem.domain.model.jaxb.UnitsType getType() {
        return _Type;
    }

    public void setType(be.ac.ulg.montefiore.run.totem.domain.model.jaxb.UnitsType value) {
        _Type = value;
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.domain.model.jaxb.impl.UnitTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        try {
            context.text(((be.ac.ulg.montefiore.run.totem.domain.model.jaxb.UnitsType) _Type).toString(), "Type");
        ...
        if (_Value instanceof be.ac.ulg.montefiore.run.totem.domain.model.jaxb.DelayUnits) {
            try {
                context.text(((be.ac.ulg.montefiore.run.totem.domain.model.jaxb.DelayUnits) _Value).toString(), "Value");
            } catch (java.lang.Exception e) {
                be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.Util.handlePrintConversionException(this, e, context);
            }
        } else {
            if (_Value instanceof be.ac.ulg.montefiore.run.totem.domain.model.jaxb.BandwidthUnits) {
                try {
                    context.text(((be.ac.ulg.montefiore.run.totem.domain.model.jaxb.BandwidthUnits) _Value).toString(), "Value");
                } catch (java.lang.Exception e) {
                    be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.Util.handlePrintConversionException(this, e, context);
                }
            } else {
...
+";H\u001c\u00ad{pzHw\u0002\u0000\u0000xp\u0000\u0000\u0000\u0002sq\u0000~\u0000\rq\u0000~\u0000\u0017t\u0000\ndelayUnitsq\u0000~\u0000\u001b\u0000\u0000q\u0000~\u0000\u001fq\u0000~\u0000\u001fq"
+"\u0000~\u0000\"sq\u0000~\u0000#w\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000\u0000\u0004t\u0000\u0007\u00c3\u00af\u00c2\u00bf\u00c2\u00bdst\u0000\u0002mst\u0000\u0002nst\u0000\u0001sxsq\u0000~\u0000\rq\u0000~\u0000\u0017"
+"t\u0000\u000ebandwidthUnitsq\u0000~\u0000\u001b\u0000\u0000q\u0000~\u0000\u001fq\u0000~\u0000\u001fq\u0000~\u0000\"sq\u0000~\u0000#w\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000\u0000\u0005t"
+"\u0000\u0004tbpst\u0000\u0004mbpst\u0000\u0004kbpst\u0000\u0004gbpst\u0000\u0003bpsxq\u0000~\u0000(psq\u0000~\u0000+t\u0000\u0005valueq\u0000~\u0000\u0017s"
...
+"ol;xp\u0000\u0000\u0000\u0001\u0001pq\u0000~\u0000\u0005x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.domain.model.jaxb.impl.UnitTypeImpl.this;
        }
        ...
        {
            try {
                _Type = be.ac.ulg.montefiore.run.totem.domain.model.jaxb.UnitsType.fromString(value);
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _Value = be.ac.ulg.montefiore.run.totem.domain.model.jaxb.DelayUnits.fromString(value);
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                _Value = be.ac.ulg.montefiore.run.totem.domain.model.jaxb.BandwidthUnits.fromString(value);
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
