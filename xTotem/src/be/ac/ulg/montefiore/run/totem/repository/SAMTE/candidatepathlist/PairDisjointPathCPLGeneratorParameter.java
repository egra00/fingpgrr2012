 ...
 */
public class PairDisjointPathCPLGeneratorParameter implements CPLGeneratorParameter {

    private int maxDepth;
    private int nbMaxPath;
    private SimplifiedDomain topo;

    public PairDisjointPathCPLGeneratorParameter(int maxDepth, SimplifiedDomain topo,int nbMaxPath) {
        this.maxDepth = maxDepth;
        this.topo = topo;
        this.nbMaxPath = nbMaxPath;
    }
