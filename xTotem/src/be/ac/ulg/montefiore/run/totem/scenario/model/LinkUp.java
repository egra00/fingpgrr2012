...
import be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.LinkUpImpl;
 ...
 */
public class LinkUp extends LinkUpImpl implements Event {

    private final static Logger logger = Logger.getLogger(LinkUp.class);
    
    public LinkUp() {}
    
    public LinkUp(String linkId) {
        setLinkId(linkId);
    }
    
    public LinkUp(int asId, String linkId) {
        this(linkId);
        setASID(asId);
    }
    ...
    public EventResult action() throws EventExecutionException {
        logger.debug("Processing a link up event - ASID: "+_ASID+" - Link ID: "+_LinkId);
        ...
        try {
            ...
            logger.info("Link " + link.getId() + " status set to up.");
