...
public class LinkLoadComputerIdException extends DataConsistencyException {
    public LinkLoadComputerIdException() {
        super();
    }

    public LinkLoadComputerIdException(String s) {
        super(s);
    }
}
