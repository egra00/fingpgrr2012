...
public class UnitImpl
    extends be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.impl.UnitTypeImpl
    implements be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.Unit, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.Unit.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.impl.UnitImpl.Unmarshaller(context);
    }
...
+";xp\u0000\u0000\u0000\u0003\u0001pq\u0000~\u0000Oq\u0000~\u0000\tq\u0000~\u0000\nx"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.impl.UnitImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("type" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.impl.UnitTypeImpl)be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.impl.UnitImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                    case  3 :
