...
public class ShowLinkLoadTypeImpl
    ...
    implements be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ShowLinkLoadType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.ShowLinkLoadType.class);
    }
    ...
    public void setClassOfService(java.lang.String value) {
        _ClassOfService = value;
    }

    public boolean isSetClassOfService() {
        return (_ClassOfService!= null);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkLoadTypeImpl.Unmarshaller(context);
    }
    ...
    public void serializeAttributes(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (_ClassOfService!= null) {
            context.startAttribute("", "classOfService");
            try {
                context.text(((java.lang.String) _ClassOfService), "ClassOfService");
        ...
        if (has_PerCos) {
            context.startAttribute("", "perCos");
            try {
                context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _PerCos)), "PerCos");
            } catch (java.lang.Exception e) {
                be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endAttribute();
...
+"\u0000~\u0000+q\u0000~\u0000-sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0012ppsq\u0000~\u00002q\u0000~\u00006t\u0000\u0007cosTypesr"
+"\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000!sr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
+"\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000\u0018q\u0000~\u0000\u001et\u0000\u0006stringq\u0000~\u0000f\u0001\u0000\u0000\u0000\u0000q\u0000~\u0000$sq\u0000~\u0000%q"
+"\u0000~\u0000iq\u0000~\u00006sq\u0000~\u0000\'t\u0000\u000eclassOfServiceq\u0000~\u0000+q\u0000~\u0000-sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000"
+"\u0011psq\u0000~\u0000\u0012ppsq\u0000~\u00002q\u0000~\u00006t\u0000\nlinkIdTypeq\u0000~\u0000fq\u0000~\u0000h\u0000\u0000\u0000\u0000q\u0000~\u0000$sq\u0000~\u0000%q"
+"\u0000~\u0000iq\u0000~\u00006sq\u0000~\u0000\'t\u0000\u0006linkIdq\u0000~\u0000+q\u0000~\u0000-sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0012"
+"ppq\u0000~\u0000hq\u0000~\u0000$sq\u0000~\u0000%q\u0000~\u0000iq\u0000~\u0000\u001esq\u0000~\u0000\'t\u0000\u0005llcIdq\u0000~\u0000+q\u0000~\u0000-sq\u0000~\u0000\u000bpp"
+"sq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0012ppsr\u0000$com.sun.msv.datatype.xsd.BooleanType"
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0018q\u0000~\u0000\u001et\u0000\u0007booleanq\u0000~\u0000\"q\u0000~\u0000$sq\u0000~\u0000%q\u0000~\u0000\u0080q\u0000~\u0000\u001esq"
+"\u0000~\u0000\'t\u0000\u0006perCosq\u0000~\u0000+q\u0000~\u0000-sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0011pq\u0000~\u0000}sq\u0000~\u0000\'t\u0000\u0007per"
+"Linkq\u0000~\u0000+q\u0000~\u0000-sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001"
...
+"{q\u0000~\u0000mq\u0000~\u0000\fq\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000/q\u0000~\u0000\u0006x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkLoadTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  15 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkLoadTypeImpl.this).new Unmarshaller(context)), 16, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  6 :
        ...
        {
            try {
                _PerCos = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_PerCos = true;
            } catch (java.lang.Exception e) {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  15 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkLoadTypeImpl.this).new Unmarshaller(context)), 16, ___uri, ___local, ___qname);
                        return ;
                    case  6 :
                        attIdx = context.getAttribute("", "llcId");
                        if (attIdx >= 0) {
                ...
                switch (state) {
                    ...
                    case  15 :
                        if (("ASID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkLoadTypeImpl.this).new Unmarshaller(context)), 16, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  15 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkLoadTypeImpl.this).new Unmarshaller(context)), 16, ___uri, ___local, ___qname);
                        return ;
                    case  6 :
                        attIdx = context.getAttribute("", "llcId");
                        if (attIdx >= 0) {
                ...
                try {
                    switch (state) {
                        ...
                        case  15 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASEventTypeImpl)be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ShowLinkLoadTypeImpl.this).new Unmarshaller(context)), 16, value);
                            return ;
                        case  6 :
                            attIdx = context.getAttribute("", "llcId");
                            if (attIdx >= 0) {
