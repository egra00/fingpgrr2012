...
public class CreatePathException extends Exception {
    ...
    /**
     * Creates a new GAinstance of <code>CreatePathException</code> without detail message.
     */
    ...
    /**
     * Constructs an GAinstance of <code>CreatePathException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public CreatePathException(String msg) {
        super(msg);
    }
}
