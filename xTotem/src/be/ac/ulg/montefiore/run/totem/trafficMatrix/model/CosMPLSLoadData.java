...
/**
 * Extends the {@link CosLoadData}, and the {@link MPLSLoadData} and add the capability to obtain the mpls load in a per
...
*/
public interface CosMPLSLoadData extends MPLSLoadData, CosLoadData {
