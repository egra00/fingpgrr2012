...
import be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.NodeUpImpl;
 ...
 */
public class NodeUp extends NodeUpImpl implements Event {

    private final static Logger logger = Logger.getLogger(NodeUp.class);
    
    public NodeUp() {}
    
    public NodeUp(String nodeId) {
        setNodeId(nodeId);
    }
    
    public NodeUp(int asId, String nodeId) {
        this(nodeId);
        setASID(asId);
    }
    ...
    public EventResult action() throws EventExecutionException {
        logger.debug("Processing a node up event - ASID: "+_ASID+" - Node ID: "+_NodeId);
        ...
        try {
            ...
            logger.info("Node " + node.getId() + " status set to up.");
