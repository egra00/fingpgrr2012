...
public class UnitTypeImpl implements be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.UnitType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{

    protected be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.UnitsType _Type;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.UnitType.class);
    }

    public be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.UnitsType getType() {
        return _Type;
    }

    public void setType(be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.UnitsType value) {
        _Type = value;
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.impl.UnitTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        try {
            context.text(((be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.UnitsType) _Type).toString(), "Type");
        ...
        if (_Value instanceof be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.DelayUnits) {
            try {
                context.text(((be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.DelayUnits) _Value).toString(), "Value");
            } catch (java.lang.Exception e) {
                be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.Util.handlePrintConversionException(this, e, context);
            }
        } else {
            if (_Value instanceof be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.BandwidthUnits) {
                try {
...
+"p\u0000\u0000\u0000\u0001\u0001pq\u0000~\u0000\u0005x"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.impl.UnitTypeImpl.this;
        }
        ...
        {
            try {
                _Type = be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.UnitsType.fromString(value);
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _Value = be.ac.ulg.montefiore.run.totem.trafficMatrix.model.jaxb.DelayUnits.fromString(value);
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
