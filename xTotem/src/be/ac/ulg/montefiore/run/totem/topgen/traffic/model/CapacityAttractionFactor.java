 ...
 */
public class CapacityAttractionFactor implements AttractionFactor {

    private static final Logger logger = Logger.getLogger(AttractionFactor.class);
    
    /**
     * Generates traffic to the node <code>node</code>. The amount of traffic
