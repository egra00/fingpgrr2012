...
/*
 * GUIAdapter can be used to reduce the number of method to implements
 * if you need to define a GUIListener by subclassing the
 * GUIAdapter and overiding only useful methods.
 *
