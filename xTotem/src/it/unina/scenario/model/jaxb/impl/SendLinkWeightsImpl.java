    ...
    implements it.unina.scenario.model.jaxb.SendLinkWeights, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (it.unina.scenario.model.jaxb.SendLinkWeights.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new it.unina.scenario.model.jaxb.impl.SendLinkWeightsImpl.Unmarshaller(context);
    }

    public void serializeBody(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://jaxb.model.scenario.unina.it", "sendLinkWeights");
...
+"w3.org/2001/XMLSchema-instanceq\u0000~\u0000,sq\u0000~\u0000&t\u0000\u000fsendLinkWeightst"
+"\u0000#http://jaxb.model.scenario.unina.itsr\u0000\"com.sun.msv.grammar"
...
+"ntt\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000_q\u0000~\u0000.q"
+"\u0000~\u0000\tq\u0000~\u0000\nq\u0000~\u0000\fx"));
        }
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return it.unina.scenario.model.jaxb.impl.SendLinkWeightsImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromEnterElement((((it.unina.scenario.model.jaxb.impl.SendLinkWeightsTypeImpl)it.unina.scenario.model.jaxb.impl.SendLinkWeightsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
                        if (("sendLinkWeights" == ___local)&&("http://jaxb.model.scenario.unina.it" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((it.unina.scenario.model.jaxb.impl.SendLinkWeightsTypeImpl)it.unina.scenario.model.jaxb.impl.SendLinkWeightsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ASID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((it.unina.scenario.model.jaxb.impl.SendLinkWeightsTypeImpl)it.unina.scenario.model.jaxb.impl.SendLinkWeightsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((it.unina.scenario.model.jaxb.impl.SendLinkWeightsTypeImpl)it.unina.scenario.model.jaxb.impl.SendLinkWeightsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  1 :
                            ...
                            spawnHandlerFromText((((it.unina.scenario.model.jaxb.impl.SendLinkWeightsTypeImpl)it.unina.scenario.model.jaxb.impl.SendLinkWeightsImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
